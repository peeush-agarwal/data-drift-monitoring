...
def prepare(dataset_name: str, dataset_path: str) -> None:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Script for data and config generation for Evidently metrics integration with Prometheus and Grafana"
    )
    parser.add_argument(
        "-d", "--dataset",
    ...
    prepare(args.dataset, args.path)
